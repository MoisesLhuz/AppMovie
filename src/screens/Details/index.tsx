...
import { BookmarkSimple, CalendarBlank, CaretLeft, Clock, Images, Star } from "phosphor-react-native";


// criar a tipagem do MovieDetails
type MovieDetails = {
    id: number;
    title: string;
    overview: string;
...
export function Details() {
    ...
    //criar funcionalidade para retornar botão de voltar
    ...
    //criar função para retornar o ano do filme
